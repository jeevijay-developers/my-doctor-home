        ...
        <Particles
          ...
          options={{
            ...
            interactivity: {
              ...
              modes: { push: { quantity: 0 }, repulse: { distance: 200, duration: 0.4 } },
            },
            particles: {
              color: { value: particleColor || "#ffffff" },
              move: { enable: true, direction: "none", random: false, straight: false, outModes: { default: "out" }, speed: { min: 0.1, max: 1 } },
