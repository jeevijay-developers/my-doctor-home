          ...
          >
            <div className="flex flex-wrap items-center gap-2">
              <motion.span
                ...
                className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-ai-purple/10 text-ai-purple text-xs font-semibold"
              >
              ...
              >
                🔥 2,847 doctors joined this month
              </motion.span>
            </div>

            <h1 className="font-heading font-extrabold text-2xl sm:text-3xl md:text-5xl lg:text-[56px] text-primary leading-[1.1]">
            ...
            <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.9 }} className="flex flex-col sm:flex-row gap-3">
              <Link to="/auth?mode=signup">
                <Button size="lg" className="bg-royal hover:bg-royal/90 text-white gap-2 text-sm px-6 shadow-lg shadow-royal/20 w-full sm:w-auto">
                  Start 7-Day Free Trial <ArrowRight className="h-4 w-4" />
                </Button>
              </Link>
              <a href="#how-it-works">
                <Button size="lg" variant="outline" className="text-sm px-6 border-2 w-full sm:w-auto">
                  See How It Works
                </Button>
              </a>
            </motion.div>

            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ delay: 1.1 }} className="flex flex-wrap gap-x-4 gap-y-1.5 text-xs text-muted-foreground pt-1">
          ...
          >
            <div className="relative">
              ...
              <motion.div
                ...
                className="absolute -top-2 right-0 bg-white rounded-xl shadow-lg px-3 py-2 border border-border hidden sm:block"
              >
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    ...
                    <div className="text-xs font-bold text-primary">Today 5:30 PM</div>
                  </div>
                </div>
              </motion.div>
              <motion.div
                ...
                className="absolute bottom-12 -left-4 bg-white rounded-xl shadow-lg px-3 py-2 border border-border hidden sm:block"
              >
                <div className="text-[10px] text-muted-foreground">Revenue This Month</div>
                <div className="text-base font-bold text-success">₹1,24,000 ↑</div>
              </motion.div>
              <motion.div
                animate={{ y: [0, -10, 0] }}
                transition={{ duration: 3, delay: 2, repeat: Infinity, ease: "easeInOut" }}
                className="absolute top-1/3 -right-2 bg-white rounded-xl shadow-lg px-3 py-2 border border-border hidden sm:block"
              >
